...
async function run(){
    try{
        ...
        const database = client.db('auto_car');
        const appointmentsCollection = database.collection('featuredcar');
        ...
        app.get('/featuredcar', verifyToken, async(req, res) => {
        ...
        app.post('/featuredcar', async(req, res) => {
        ...
        app.delete('/featuredcar/:id', async(req, res) =>{
          const id = req.params.id;
          const query = {_id:ObjectId(id)};
